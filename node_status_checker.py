            ...
            if RESPONCE.status_code == 200 :
                ...
                for NODE in RESPONCE_DATA :
                    ...
                    if RD_NODE_STATUS == "error" or RD_NODE_STATUS == "connecting" :
                        ...
                        # set text
                        TEXT = f"🚨<b>مشکلی در یکی از نود های سرورتون پیدا شده! هرچه زودتر بررسی کنید. برای مزاحم نشدن به بررسی شما ، بات تا 2 دقیقه آینده نودهارو چک نخواهد کرد.<br><br>سرور نود :</b> {RD_NODE_NAME}\n<b>آیپی نود : </b>{RD_NODE_ADDRESS}\n<b>وضعیت نود : </b>{RD_NODE_STATUS}\n<b>پیام پنل : </b>\n{RD_NODE_MESSAGE}"
