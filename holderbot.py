    ...
    try :
        ...
        if data == "yes":
            ...
            if inbounschecker.status_code == 200 :
                ...
                await client.send_message(chat_id=admin_telegram_bot , text="<b>❌ i can't check inbounds !</b>\n<code>{str(responce.text)}</code>" , parse_mode=enums.ParseMode.HTML) 
                return
