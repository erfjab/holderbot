...
async def holderbot(client: Client, message: Message) :
    ...
    try :
        ...
        ERROR_MESSAGE = f"❌<b> ERR (Please <a href='https://github.com/erfjab/holderbot/issues'>issue</a>) :</b>\n\n<pre>{str(e)}</pre>\n"
        UPDATE_STEP = DEF_UPDATE_STEP(MESSAGE_CHATID,"None")
        await client.send_message(chat_id=MESSAGE_CHATID, text=ERROR_MESSAGE, parse_mode=enums.ParseMode.HTML , disable_web_page_preview=True)                                     
